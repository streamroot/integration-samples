# CDN Load Balancer plugin for ExoPlayer integration on Android (Kotlin)
...
**Not into Tutorials?** Take a look at our [sample app](https://github.com/streamroot/integration-samples/tree/master/cdn-load-balancer/android/ExoPlayerCDNLoadBalancerPlugin) 
...
### Plugin versioning
For a given `io.streamroot.lumen.delivery.client:orchestrator-plugin-exoplayer-2-18:23.3.0.0`:
...
- `23.3.0.0` is the CDN Load Balancer SDK version (`23.3.0`) appended with a plugin version (`.0`)
