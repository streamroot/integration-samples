...
### Plugin versioning
For a given `io.streamroot.lumen.delivery.client:orchestrator-plugin-exoplayer-2-17:22.09.0.0`:
...
- `22.09.0.0` is the CDN Load Balancer SDK version (`22.09.0`) appended with a plugin version (`.0`)
