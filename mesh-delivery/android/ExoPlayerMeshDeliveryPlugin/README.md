...
### Plugin versioning
For a given `io.streamroot.lumen.delivery.client:mesh-plugin-exoplayer-2-18:22.09.1.0`:
...
- `22.09.1.0` is the Mesh Delivery SDK version (`22.09.1`) appended with a plugin version (`.0`)
